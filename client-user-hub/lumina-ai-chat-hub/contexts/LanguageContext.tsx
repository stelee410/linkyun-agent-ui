...
const translations = {
  en: {
    ...
    chat: {
      ...
      inviteToGroup: "Invite Agents to Group Chat",
      upgradeHint: "After adding agents, this conversation will be converted to a group chat and history will be copied automatically.",
      noOtherFriends: "Add more Agent friends to start a group chat",
      remove: "Remove",
      add: "Add",
  ...
  zh: {
    ...
    chat: {
      ...
      placeholder: "输入聊天主题...",
      inChat: "当前聊天中的助手",
      inviteToGroup: "邀请 Agent 加入群聊",
      upgradeHint: "添加 Agent 后，当前对话将自动转为群聊，历史消息会一并复制。",
      noOtherFriends: "先去添加更多 Agent 好友，再来创建群聊",
      remove: "移除",
      add: "添加",
