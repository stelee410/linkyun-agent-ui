...
/** 统一图标组件，均支持 className */

export function LogoIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 2L9 6h2v4h2V6h2L12 2zm-1 8a4 4 0 104 4 4 4 0 00-4-4zm2 4a2 2 0 11-4 0 2 2 0 014 0zM5 10l-3 4h2v6h2v-6h2L5 10zm14 0l-3 4h2v6h2v-6h2l-1-4z" />
    </svg>
  );
}
...
export function ArchiveIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-5 3h4" />
    </svg>
  );
}

export function TestPlayIcon({ className }: { className?: string }) {
  return (
